...
def generate(with_context):
    ...
    if with_context:        
        user_df, item_df, context_df, __, rating_df, user_profile_df = wf_util.load_dataset(file_type_list=['user', 'item', 'context', 'rating', 'user profile'], wf_type='wf_replicate_dataset')
    else:
        user_df, item_df, __, __, rating_df, user_profile_df = wf_util.load_dataset(file_type_list=['user', 'item', 'rating', 'user profile'], wf_type='wf_replicate_dataset')   
