...
class BooleanArrayListAttributeGenerator(AttributeGenerator):
    ...
    def generate_attribute_value(self, position):
        ...
        Example of item_schema.conf:
            ...
            generator_type_attribute_6=BooleanArrayListAttributeGenerator
...
# bool_array_list_generator = BooleanArrayListAttributeGenerator(schema_access)
