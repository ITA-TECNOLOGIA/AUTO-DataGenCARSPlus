...
class TestGeneratorSyntheticDataset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # user_profile_df:
        user_profile_file_path = 'resources/dataset_sts/user_profile.csv'
        ...
        # RS:
        # rating_df:
        rating_file_path = 'resources/dataset_sts_rs/ratings.csv'
        rating_df_rs = pd.read_csv(rating_file_path, encoding='utf-8', index_col=False, sep=';')
        # user_profile_df (RS):
        user_profile_file_path = 'resources/dataset_sts_rs/user_profile.csv'
        user_profile_df_rs = pd.read_csv(user_profile_file_path, encoding='utf-8', index_col=False, sep=',')
        # item_df:
        item_file_path = 'resources/dataset_sts_rs/item.csv'
    ...
    def test_greplicate_dataset_cars(self):
        ...
        '''        
        rating_file = self.__generator_cars.replicate_dataset(percentage_rating_variation=25)        
    ...
    def test_greplicate_dataset_rs(self):
        ...
        '''        
        rating_file = self.__generator_rs.replicate_dataset(percentage_rating_variation=25)
        logging.info(f'rating_file: {rating_file}')
        self.assertEqual(rating_file.shape[0], 2534)
