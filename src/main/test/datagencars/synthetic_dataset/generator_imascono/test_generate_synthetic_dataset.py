...
class TestGeneratorSyntheticDataset(unittest.TestCase):
    ...
    def test_generate_user_file(self):
        ...
        '''
        # user_schema.conf
        user_schema_file_path = 'resources/data_schema_imascono/user_schema.conf'
    ...
    def test_generate_behavior_file(self):
        ...
        behavior_schema_file_path = 'resources/data_schema_imascono/behavior_schema.conf'
    ...
    def test_generate_rating_file_cars(self):
        ...
        '''
        # user_df:
        user_path = 'resources/data_schema_imascono/user.csv'
