...
class TestGeneratorSyntheticDataset(unittest.TestCase):
    ...
    def test_generate_user_file(self):
        ...
        '''
        # user_schema.conf
        user_schema_file_path = 'resources/data_schema_2d/user_schema.conf'
    ...
    def test_generate_item_file_correlation(self):
        ...
        '''        
        # item_schema.conf
        item_schema_file_path = 'resources/data_schema_2d/item_schema.conf'
        with open(item_schema_file_path, 'r') as item_schema_file:
            item_schema = item_schema_file.read()  
        # item_profile.conf
        item_profile_path = 'resources/data_schema_2d/item_profile.conf'
    ...
    def test_generate_rating_file(self):
        ...
        '''
        # user_df:
        user_path = 'resources/data_schema_2d/user.csv'
        user_df = pd.read_csv(user_path, encoding='utf-8', index_col=False)
        # user_profile_df:
        user_profile_path = 'resources/data_schema_2d/user_profile.csv'
        user_profile_df = pd.read_csv(user_profile_path, encoding='utf-8', index_col=False)
        # item_df:
        item_path = 'resources/data_schema_2d/item.csv'
        ...
        rating_file = self.__generator.generate_rating_file(user_df, user_profile_df, item_df, item_schema)
        print(rating_file)
