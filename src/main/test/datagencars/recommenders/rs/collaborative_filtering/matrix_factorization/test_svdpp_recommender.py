...
class TestSVDppRecommender(unittest.TestCase):    
    """
    ...
    def setUp(self):
        ...
        self.__rs = SVDpp(n_factors=n_factors, n_epochs=n_epochs, lr_all=lr_all, reg_all=reg_all)
    
    def tearDown(self):
        del self.__rs
    
    def test_svdpp_recommender_metrics(self):
    ...
    def test_svdpp_recommender_cross_validation(self):
