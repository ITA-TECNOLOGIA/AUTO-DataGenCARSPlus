...
class TestKNNBasicRecommender(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        self.__rs = KNNBasic(k=k, min_k=min_k, sim_options=sim_options)
    
    def tearDown(self):
        del self.__rs
    
    def test_knn_basic_recommender_metrics(self):
    ...
    def test_knn_basic_recommender_cross_validation(self):
